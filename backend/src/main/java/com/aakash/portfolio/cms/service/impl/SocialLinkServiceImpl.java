...
public class SocialLinkServiceImpl implements SocialLinkService {
    ...
    public SocialLinkResponse createSocialLink(SocialLinkRequest request) {
        ...
        if (socialLinkRepository.existsByProfileIdAndPlatformIgnoreCase(
            ...
            throw new IllegalArgumentException(
                    "Social link already exists for platform: "
                            + request.getPlatform());
        }
    ...
    public SocialLinkResponse updateSocialLink(Long id, SocialLinkRequest request) {
        ...
        if (!socialLink.getPlatform().equalsIgnoreCase(request.getPlatform())
                && socialLinkRepository.existsByProfileIdAndPlatformIgnoreCase(
                        socialLink.getProfile().getId(),
                        request.getPlatform())) {
